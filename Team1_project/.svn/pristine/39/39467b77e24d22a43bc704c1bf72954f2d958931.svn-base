		...
		<div class="col-9">
			...
			<div id="insertForm">
	            ...
	            <div class="cont1 xsCont">
	            	<div>
	                <label for="title" class="form-label">업체명</label>
	                <input class="form-control" type="text" id="rent_nm" name="rent_nm" required>
	            </div>
	            <div>
	                <label for="title" class="form-label">업체코드</label>
	                <input class="form-control" type="text" id="rent_code" name="rent_code" required>
	            </div>
	            <div>
	                <label for="title" class="form-label">전화번호</label>
	                <input class="form-control" type="text" id="rent_tel" name="rent_tel" required>
	            </div>
	            <div>
	                <label for="title" class="form-label">주소</label>
	                <input class="form-control" type="text" id="rent_addr" name="rent_addr" required>
	            </div>
	            <div>
	                <label for="title" class="form-label">이메일</label>
	                <input class="form-control" type="text" id="rent_mail" name="rent_mail" required>
	            </div>
