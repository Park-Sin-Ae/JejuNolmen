...
@WebServlet("/managementLodgingList.do")
public class ManagementLodgingList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<ManagementLodgingVO> vo = service.lodgingList();
		
		request.setAttribute("lodgingList", vo);
